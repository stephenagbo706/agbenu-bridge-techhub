...
const LABS: LabDef[] = [
  ...
  { id: "lab-ai-builder", courseId: "c-ai", title: "AI Builder Lab", desc: "Choose components and build a small AI system", icon: "🎮", minutes: 15 },
  { id: "lab-ai-coding-tools", courseId: "c-ai", title: "AI Coding Tools Lab", desc: "Practice safe AI-assisted coding workflows", icon: "🧑‍💻", minutes: 15 },
  // Robotics Labs
...
export function VirtualLabsView({ courseId }: { courseId?: string }) {
  ...
  const renderLab = (labId: LabId) => {
    switch (labId) {
      ...
      case "lab-ai-builder": return <AIBuilderLabSim />;
      case "lab-ai-coding-tools": return <AICodingToolsSim />;
